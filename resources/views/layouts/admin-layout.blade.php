            ...
            <div class="tab-content" id="setting-content">
                <div class="tab-pane fade show active scroll-wrapper" id="todo-section" role="tabpanel" aria-labelledby="todo-section">
                    ...
                    <div class="events pt-4 px-3">
                        ...
                        <p class="mb-0 font-weight-thin text-gray">Creating component page build a asset/js</p>
            ...
            <ul class="nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse" id="charts">
                        <ul class="nav flex-column sub-menu">
                            <li class="nav-item"> <a class="nav-link" href="pages/charts/chartasset/js.html">Chartasset/js</a></li>
                        </ul>
                    </div>
                </li>
                <li class="nav-item">
...
<!-- End custom asset/js for this page-->
</body>
